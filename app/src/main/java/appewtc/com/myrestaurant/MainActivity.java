...
public class MainActivity extends ActionBarActivity {
    ...
    public void clickLogin(View view) {
        ...
        if (strUserChoose.equals("") || strPasswordChoose.equals("") ) {
            ...
            objMyAlert.errorDialog(MainActivity.this, "không có gì cả ", "Xin vui lòng nhập dữ liệu");
    ...
    private void checkUser() {
        ...
        try {
            ...
            MyAlertDialog objMyAlert = new MyAlertDialog();
            objMyAlert.errorDialog(MainActivity.this, " không có  User", " không có " + strUserChoose + " Trong Database");
        }
    ...
    private void checkPassword() {
        ...
        if (strPasswordChoose.equals(strPasswordTrue)) {
            ...
            MyAlertDialog objMyAlert = new MyAlertDialog();
            objMyAlert.errorDialog(MainActivity.this, "Mật khẩu không đúng", "Xin vui lòng nhập lại");
    ...
    private void synJSonToSQLite() {
        ...
        try {
            ...
            HttpPost objHttpPost = new HttpPost("http://192.168.86.1/connn/get.php");
        ...
        try {
            ...
            for (int i = 0; i < objJSONArray.length(); i++) {
                ...
                long insertVale = objUserTABLE.addValueToUser(strUser, strPassword, strName);
    ...
    private void testAddValue() {
        ...
        objUserTABLE.addValueToUser("User", "Password", "Name");
        objOrderTABLE.addValueOrder("Name", "Bang", "Food", 4);
        objFoodTABLE.addValueToFood("Food", "Gia");
